...
// Prompt: Create a premium 3D-rendered desktop pet sprite for TokenCut: an original
...
struct PetFace: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(paused ? "TokenCut pet. Optimization paused." : "TokenCut pet. Drag to move.")
