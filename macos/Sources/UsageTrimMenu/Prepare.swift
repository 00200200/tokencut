    ...
    func prepare() {
        ...
        Task {
            ...
            do {
                ...
                guard revision == version else { return }
                self.error = "Could not prepare this draft. Your original is intact. Check the local UsageTrim installation."
            }
        }
    }
    func copyPreview() {
...
struct PrepareView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Preview counts are not account usage or recorded savings. Nothing reads your chats. The original stays here until cleared; compaction may save a redacted copy in UsageTrim’s local recovery cache.")
...
@MainActor enum PrepareWindow {
    ...
    static func show() {
        if window == nil {
            ...
            panel.title = "UsageTrim — Prepare for chat"
